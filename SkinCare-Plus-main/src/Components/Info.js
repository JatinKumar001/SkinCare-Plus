    ...
    <div className="info-section" id="services">
      <div className="info-title-content">
        ...
        <p className="info-description">
          We bring skincare to your convenience, offering a comprehensive range of on-demand dermatological services tailored to your needs. Our platform allows you to connect with experienced online dermatologists who provide expert advice on detecting skin cancer using images, issue online prescriptions, and offer personalized product recommendations whenever you require them.
        </p>
      </div>
